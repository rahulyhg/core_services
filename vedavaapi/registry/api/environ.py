...
def _get_registry_colln():
    return myservice().get_registry_colln(get_current_org())


def _get_registry_resource_id():
    return myservice().get_registry_resource_id(get_current_org())
...
def push_environ_to_g():
    from flask import g
    g.registry_colln = _get_registry_colln()
    g.registry_resource_id = _get_registry_resource_id()
